    ...
    className='flex flex-col justify-center items-center text-center my-20'>
        ...
        className='flex flex-wrap justify-center mt-16 gap-3'>
            {Array(6).fill().map((item,index)=>(
                ...
                className='rounded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10' src={index%2 ? assets.sample_img_1 : assets.sample_img_2} key={index} width={70}/>
            ))}
        </motion.div>
    </motion.div>
  )
